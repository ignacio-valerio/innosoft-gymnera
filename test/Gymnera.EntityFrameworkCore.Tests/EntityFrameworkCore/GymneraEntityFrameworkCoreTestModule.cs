...
[DependsOn(
    typeof(GymneraApplicationTestModule),
    typeof(GymneraEntityFrameworkCoreModule),
    typeof(AbpEntityFrameworkCoreSqliteModule)
)]
public class GymneraEntityFrameworkCoreTestModule : AbpModule
{
    ...
    private void ConfigureInMemorySqlite(IServiceCollection services)
    {
        ...
        _database.CreateTables(
            new GymneraDbContext(new DbContextOptionsBuilder<GymneraDbContext>().UseSqlite(_database.ConnectionString).Options));
