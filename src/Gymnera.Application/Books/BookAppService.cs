...
[Authorize(GymneraPermissions.Books.Default)]
public class BookAppService : ApplicationService, IBookAppService
{
    ...
    [Authorize(GymneraPermissions.Books.Create)]
    ...
    [Authorize(GymneraPermissions.Books.Edit)]
    ...
    [Authorize(GymneraPermissions.Books.Delete)]
